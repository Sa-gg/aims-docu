...
│   │   │   ├── cha1&2_v4_chapter1-final.docx  ← Chapter 1 only (finalized)
│   │   │   ├── cha1&2_v5.docx                 ← Colegado fixed, new local sources added
│   │   │   ├── cha1&2_v6.docx                 ← intermediate revision
│   │   │   ├── cha1&2_v7.docx                 ← ATLAS matrix table + Ch2 spacing fixed
│   │   │   └── cha1&2_v8.docx                 ← CURRENT — references appended at end
│   │   ├── draft/
│   │   │   └── CHAP2-REF.docx                 ← teammate's draft reference list (review only)
│   │   └── final/
│   │       └── Orbigoso_Sagum_Zambra_AIMS_Chap1-2.pdf  ← SUBMISSION-READY PDF
│   └── ATLAS/
│       └── Curio_Gilera_Gromea_ATLAS_Chap1-2.docx  ← friend's capstone (reference only)
│
├── formats/
...
│
├── references/
│   ├── references_v1_original.docx  ← original raw reference list — NEVER TOUCH
│   ├── references_v3.docx           ← APA 7th edition (matches cha1&2_v3.docx)
│   ├── references_v6.docx           ← 16 sources, all verified
│   └── references_v7.docx           ← CURRENT — annotated with usage location notes
│
└── scripts/
...
| v5 | `papers/AIMS/revisions/cha1&2_v5.docx` | Colegado fixed; Jumao-as & Gajardo added |
| v6 | `papers/AIMS/revisions/cha1&2_v6.docx` | Intermediate revision |
| v7 | `papers/AIMS/revisions/cha1&2_v7.docx` | ATLAS matrix table + Ch2 spacing fixed |
| v8 | `papers/AIMS/revisions/cha1&2_v8.docx` | **CURRENT** — references appended at end (ATLAS-style) |
| PDF | `papers/AIMS/final/Orbigoso_Sagum_Zambra_AIMS_Chap1-2.pdf` | **SUBMISSION-READY** — generated from v8 |
...
| v6 | `references/references_v6.docx` | 11 foreign + 5 local = 16 total sources |
| v7 | `references/references_v7.docx` | **CURRENT** — annotated with ↳ usage location notes per entry |

**Reference files should match the version number of their corresponding paper.**

### Folder Convention for AIMS Papers

| Folder | Purpose |
|--------|---------|
| `papers/AIMS/original/` | Preserved originals — NEVER modify |
| `papers/AIMS/revisions/` | All working `.docx` versions — always create new, never overwrite |
| `papers/AIMS/draft/` | Teammate drafts and incoming reference files for review only |
| `papers/AIMS/final/` | Submission-ready exports (PDF) — one file at a time, named `Lastname1_Lastname2_Lastname3_AIMS_Chap1-2.pdf` |
